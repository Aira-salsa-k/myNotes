...
/**
 * HudAreaChart component
 * @param {Object} props
 * @param {boolean} [props.showYAxis=false]
 * @param {Array} [props.data=[]]
 * @param {string} [props.gradientColor="#ffffff"]
 * @param {string} [props.borderColor="#ffffff"]
 * @param {string} [props.dotColor="#ffffff"]
 * @param {number} [props.dotSize=0.8]
 * @param {number} [props.dotOpacity=0.1]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          clipPath:
            "polygon(0.6% 0.7%, 99.3% 0.7%, 99.3% 89.2%, 89.5% 99%, 0.6% 99%)",
        }}
      >
      ...
      {hoveredData && (
        <div className="absolute bottom-4 left-10 text-lime-300 font-mono text-[10px] z-20">
